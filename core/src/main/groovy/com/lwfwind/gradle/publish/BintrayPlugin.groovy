...
class BintrayPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ...
        new BintrayConfiguration(project.publish).configure(project)
        initBintrayUploadTask(bintrayUpload, extension)
    }

    void initBintrayUploadTask(BintrayUploadTask bintrayUpload, BintrayExtension extension) {
        bintrayUpload.with {
